      				...
      				<div class="table-responsive">
      				  <table class="table table-hover" id="tablaalumnos" border="1">
      				    ...
      				    <tbody>
      				      	<tr>
      				        	<td>
	      				        	<input type="text" readonly value="13051040" style="border:none; width: 70px;">
      				        	</td>
      				        	<td>
	      				        	<input type="text" readonly value="Lorem ipsum dolor sit amet, consectetur adipisicing elit." style="border:none; width:350px;">
      				        	</td>
      				        	<td>
      				      	...
      				      	<tr>
	      				        <td>
	      				        	<input type="text" readonly value="13051041" style="border:none; width: 70px;">
	      				        </td>
      				        	<td>
      				        		<input type="text" readonly value="Lorem ipsum dolor sit amet, consectetur adipisicing elit." style="border:none; width:350px;">
      				        	</td>
      				      	...
      				      	<tr>
      				        	<td>
      				        		<input type="text" readonly value="13051042" style="border:none; width: 70px;">
      				        	</td>
      				        	<td>
      				        		<input type="text" readonly value="Lorem ipsum dolor sit amet, consectetur adipisicing elit." style="border:none; width:350px;">
      				        	</td>
      				      	...
      				      	<tr>
      				        	<td>
      				        		<input type="text" readonly value="13051043" style="border:none; width: 70px;">
      				        	</td>
      				        	<td>
      				        		<input type="text" readonly value="Lorem ipsum dolor sit amet, consectetur adipisicing elit." style="border:none; width:350px;">
      				        	</td>
